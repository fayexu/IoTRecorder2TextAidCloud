...
def publish_messages(project_id, topic_id, file_path):
...
if __name__ == "__main__":
    ...
    parser.add_argument("file_path", help="Path to publish file")
    ...
    if args.command == "list":
        ...
        publish_messages(args.project_id, args.topic_id, args.file_path)
